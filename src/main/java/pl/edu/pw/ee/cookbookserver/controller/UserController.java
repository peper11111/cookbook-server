...
public class UserController {
    ...
    public ResponseEntity readRecommended(@PathVariable Long id, @RequestParam Map<String, String> params) throws Exception {
        return userService.readRecommended(id, new JSONObject(params));
    }
